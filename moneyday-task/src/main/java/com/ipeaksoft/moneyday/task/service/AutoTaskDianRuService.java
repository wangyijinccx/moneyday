...
import com.ipeaksoft.moneyday.task.thread.AutoTaskDianRuThread;

@Lazy(false)
@Component
public class AutoTaskDianRuService {
	...
	public void schedule() {
		...
		threadPoolTaskExecutor.execute(new AutoTaskDianRuThread(taskAutoService, taskFastService, util));
