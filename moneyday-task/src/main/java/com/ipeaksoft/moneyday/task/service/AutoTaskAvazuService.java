...
import com.ipeaksoft.moneyday.task.thread.AutoTaskAvazuThread;

@Lazy(false)
@Component
public class AutoTaskAvazuService {
	...
	public void schedule() {
		...
		threadPoolTaskExecutor.execute(new AutoTaskAvazuThread(taskAutoService, taskFastService, util));
