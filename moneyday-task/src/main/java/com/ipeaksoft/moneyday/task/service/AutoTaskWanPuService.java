...
import com.ipeaksoft.moneyday.task.thread.AutoTaskWanPuThread;

@Lazy(false)
@Component
public class AutoTaskWanPuService {
	...
	public void schedule() {
		...
		threadPoolTaskExecutor.execute(new AutoTaskWanPuThread(taskAutoService, taskFastService, util));
