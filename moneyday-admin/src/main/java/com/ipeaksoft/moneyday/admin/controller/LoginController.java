...
public class LoginController extends BaseController{
	...
	public String loginSuccess(ModelMap map, Principal principal,
		...
		if(4 == user.getLevel()) {
			...
			return "redirect:/search/search_performance";
		}
	}

	@RequestMapping(value = "/login")
	public String login(ModelMap map, Principal principal, HttpServletRequest request) {
		//验证用户和密码
		System.out.println("--------------------------验证用户和密码,暂时未true----------------------");
		return "redirect:/search/search_performance";
	}
